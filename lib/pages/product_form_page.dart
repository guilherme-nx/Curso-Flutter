          ...
          : Padding(
              ...
              child: Form(
                ...
                child: ListView(
                  children: [
                    TextFormField(
                      initialValue: _formData.isEmpty ? '' : _formData['name'].toString(),
                    ...
                    TextFormField(
                      initialValue: _formData.isEmpty ? '' : _formData['price'].toString(),
                    ...
                    TextFormField(
                        initialValue: _formData.isEmpty ? '' : _formData['description'].toString(),
                        ...
                        validator: (_description) {
                          ...
                          if (description.trim().length < 10) {
                            return 'Descrição precisa ter pelo menos 10 caracteres';
                          }
